...
javac -cp . -d . ../java/src/test/java/fr/in2p3/cc/storage/treqs/hsm/hpssJNI/NativeBridgeTester.java
...
java -Djava.library.path=`pwd`:/opt/hpss/lib/ -ea -cp ./ fr.in2p3.cc.storage.treqs.hsm.hpssJNI.NativeBridgeTester
