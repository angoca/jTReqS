...
javac -cp ./:../vendor/junit/junit4.8.2/junit-4.8.2.jar:../vendor/slf4j/slf4j-1.6.1/slf4j-api-1.6.1.jar -d . ../src/test/java/fr/in2p3/cc/storage/treqs/hsm/hpssJNI/HSMNativeBridgeTest.java
javac -cp ./:../vendor/junit/junit4.8.2/junit-4.8.2.jar:../vendor/slf4j/slf4j-1.6.1/slf4j-api-1.6.1.jar -d . ../src/test/java/fr/in2p3/cc/storage/treqs/hsm/hpssJNI/HSMNativeBridgeContextTest.java
javac -cp ./:../vendor/junit/junit4.8.2/junit-4.8.2.jar:../vendor/slf4j/slf4j-1.6.1/slf4j-api-1.6.1.jar -d . ../src/test/java/fr/in2p3/cc/storage/treqs/hsm/hpssJNI/HSMNativeBridgeContextBadUserTest.java
javac -cp ./:../vendor/junit/junit4.8.2/junit-4.8.2.jar:../vendor/slf4j/slf4j-1.6.1/slf4j-api-1.6.1.jar -d . ../src/test/java/fr/in2p3/cc/storage/treqs/hsm/hpssJNI/HSMNativeBridgeContextBadAuthTest.java
javac -cp ./:../vendor/junit/junit4.8.2/junit-4.8.2.jar:../vendor/slf4j/slf4j-1.6.1/slf4j-api-1.6.1.jar -d . ../src/test/java/fr/in2p3/cc/storage/treqs/hsm/hpssJNI/HPSSJNIBridgeTest.java
